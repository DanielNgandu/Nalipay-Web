            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        ?>
                        <form class="form-sample" action = "add_group_member_action.php" name="myForm" id="main" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="f_name" class="form-control" type="text" placeholder="First Name" value="" name="f_name" required="required">
                                        </div>
                                        <div class="col-sm-5 messages"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="phone_number" class="form-control" type="text" placeholder="Phone No." value
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="group" class="form-control" type="text"  name="group" required="required">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="group_member_address" class="form-control" name="group_member_address" value="" placeholder=" " required="required">
                                        </div>
                                    </div>
                                    <div class="col-sm-5 messages"></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="account_balance" class="form-control" name="account_balance" value="" placeholder="" required="required">
                                        </div>
                                    </div>
                                    <div class="col-sm-5 messages"></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <button type="submit" class="btn btn-success btn-lg offset-11" name="add_group_mem_btn">SAVE</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
