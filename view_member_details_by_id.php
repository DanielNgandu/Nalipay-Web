...
//    it is also best to add exit; after header. Otherwise, your code may want to continue to execute.
    ...
    if(isset($_GET["group_mem_id"])){
        ...
        $sql = "SELECT * FROM `group_members` LEFT JOIN groups ON group_members.group_id = groups.group_id WHERE group_members.group_mem_id =".$group_mem_id ;
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        ?>
                        <form class="form-sample" action = "edit_group_member.php" name="myForm" id="main" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="asset_id" class="form-control" name="asset_id" value="<?php echo $group_mem_id;?>" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="col-sm-5 messages"></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="assignment_station_name" class="form-control" name="assignment_station_name" value="<?php echo number_format($account_balance);?>" placeholder="" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-sm-5 messages"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="assignment_station_manager" class="form-control" name="assignment_station_manager" value="<?php echo $date_created;?>" placeholder="" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-sm-5 messages"></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <a href="edit_group_member.php?group_mem_id=<?php echo $group_mem_id;?>"><button type="button" class="btn btn-danger btn-lg offset-11" name="edit_asset_btn">EDIT</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
