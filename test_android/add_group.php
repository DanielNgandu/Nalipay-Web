            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        ?>
                        <form class="form-sample" action = "add_group_action.php" name="myForm" id="main" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="group_name" class="form-control" type="text" placeholder="First Name" value="" name="group_name" required="required">
                                        </div>
                                        <div class="col-sm-5 messages"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="group_address" class="form-control" name="group_address" value="" placeholder=" " required="required">
                                        </div>
                                    </div>
                                    <div class="col-sm-5 messages"></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Starting Bal.(K)</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <button type="submit" class="btn btn-success btn-lg offset-11" name="add_group_btn">SAVE</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
